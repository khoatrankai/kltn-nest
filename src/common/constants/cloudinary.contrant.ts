export const BUCKET = `https://res.cloudinary.com/ddwjnjssj/image/upload/v1694193665`
export const BUCKET_PREFIX = `https://res.cloudinary.com/ddwjnjssj/image/upload/v1694193665`
...
export const BUCKET_ICON_SERVICE_RECRUITMENT = `${BUCKET_IMAGE}/icons/service-recruitment`
export const BUCKET_ICON_SERVICE_RECRUITMENT_UPLOAD = `images/icons/service-recruitment`
export const BUCKET_ICON_SERVICE_RECRUITMENT_IMAGES = `${BUCKET_IMAGE}/icons/service-recruitment-images`
export const BUCKET_ICON_SERVICE_RECRUITMENT_IMAGES_UPLOAD = `images/icons/service-recruitment-images`
export const BUCKET_IMAGE_THEME_COMPANIES = `${BUCKET_IMAGE}/theme-companies`
export const BUCKET_IMAGE_THEME_COMPANIES_UPLOAD = `images/theme-companies`
export const BUCKET_IMAGE_THEME_COMPANIES_LOGO = `${BUCKET_IMAGE}/theme-companies-logo`
export const BUCKET_IMAGE_THEME_COMPANIES_LOGO_UPLOAD = `images/theme-companies-logo`